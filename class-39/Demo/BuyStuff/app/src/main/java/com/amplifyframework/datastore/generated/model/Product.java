...
public final class Product implements Model {
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    private Builder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, String productImageS3Key, String productLatitude, String productLongitude, Contact contactPerson) {
      this.id = id;
      this.name = name;
      this.description = description;
      this.dateCreated = dateCreated;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, String productImageS3Key, String productLatitude, String productLongitude, Contact contactPerson) {
      super(id, name, description, dateCreated, productCategory, productImageS3Key, productLatitude, productLongitude, contactPerson);
      Objects.requireNonNull(name);
    }
