...
public final class Product implements Model {
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    private Builder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, Contact contactPerson) {
      this.id = id;
      this.name = name;
      this.description = description;
      this.dateCreated = dateCreated;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, Contact contactPerson) {
      super(id, name, description, dateCreated, productCategory, contactPerson);
      Objects.requireNonNull(name);
    }
