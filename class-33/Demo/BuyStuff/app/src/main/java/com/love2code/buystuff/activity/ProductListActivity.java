...
//        Contact contact1=
//                Contact.builder()
//                        .email("thaer27@gmail.com")
//                        .fullName("Thaer Selawe")
//                        .build();
//        Contact contact2=
//                Contact.builder()
//                        .email("Jon@gmail.com")
...
//                        .fullName("Sara anyname")
//                        .build();
//       Amplify.API.mutate(
//               ModelMutation.create(contact1),
//               successResponse -> Log.i(TAG, "ProductListActivity.onCreate(): made a contact successfully"),
//               failureResponse -> Log.i(TAG, "ProductListActivity.onCreate(): contact failed with this response: "+failureResponse)
//       );
//        Amplify.API.mutate(
