...
public final class Product implements Model {
  ...
  private Product(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, String productImageS3Key, Contact contactPerson) {
    this.id = id;
    this.name = name;
  ...
  public static class Builder implements NameStep, BuildStep {
    ...
    private Builder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, String productImageS3Key, Contact contactPerson) {
      this.id = id;
      this.name = name;
      this.description = description;
      this.dateCreated = dateCreated;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Temporal.DateTime dateCreated, ProductCategoryEnum productCategory, String productImageS3Key, Contact contactPerson) {
      super(id, name, description, dateCreated, productCategory, productImageS3Key, contactPerson);
      Objects.requireNonNull(name);
    }
